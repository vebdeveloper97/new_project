...
<head>
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="../web/assets/images/favicon.png">
    <!-- Bootstrap Core CSS -->
    <link href="../web/assets/node_modules/bootstrap/css/bootstrap.min.css" rel="stylesheet">
    <link href="../web/assets/node_modules/perfect-scrollbar/css/perfect-scrollbar.css" rel="stylesheet">
    <!-- This page CSS -->
    <!-- chartist CSS -->
    <link href="../web/assets/node_modules/morrisjs/morris.css" rel="stylesheet">
    <!--c3 CSS -->
    <link href="../web/assets/node_modules/c3-master/c3.min.css" rel="stylesheet">
    <!-- Custom CSS -->
    <link href="<?= ADMIN ?>/css/style.css" rel="stylesheet">
    <!-- Dashboard 1 Page CSS -->
    <link href="<?= ADMIN ?>/web/css/pages/dashboard1.css" rel="stylesheet">
    <!-- You can change the theme colors from here -->
    <link href="<?= ADMIN ?>/web/css/colors/default.css" id="theme" rel="stylesheet">
</head>
            ...
            <div class="navbar-header">
                <a class="navbar-brand" href="index.html">
                    <!-- Logo icon --><b>
                        ...
                        <!-- Dark Logo icon -->
                        <img src="<?= ADMIN ?>/web/assets/images/logo-icon.png" alt="homepage" class="dark-logo"/>
                        <!-- Light Logo icon -->
                        <img src="<?= ADMIN ?>/web/assets/images/logo-light-icon.png" alt="homepage"
                             class="light-logo"/>
                    </b>
                    <!-- Logo text --><span>
                            <!-- dark Logo text -->
                            <img src="<?= ADMIN ?>/web/assets/images/logo-text.png" alt="homepage" class="dark-logo"/>
                        <!-- Light Logo text -->
                            <img src="<?= ADMIN ?>/web/assets/images/logo-light-text.png" class="light-logo"
                                 alt="homepage"/></span>
                </a>
            </div>
                    ...
                    <li class="nav-item dropdown u-pro">
                        <a class="nav-link dropdown-toggle waves-effect waves-dark profile-pic" href="#"
                           id="navbarDropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img
                                    src="<?= ADMIN ?>/web/assets/images/users/1.jpg" alt="user" class=""/> <span
        ...
        <div class="container-fluid">
            <div class="row page-titles">
                ...
                <div class="col-md-7 align-self-center">
                    <a href="https://www.wrappixel.com/templates/adminwrap/"
                       class="btn waves-effect waves-light btn btn-info pull-right hidden-sm-down text-white"> Upgrade
                        to
                        Pro</a>
                </div>
            </div>
            ...
            <div class="row">
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive mt-3 no-wrap">
                                <table class="table vm no-th-brd pro-of-month">
                                    ...
                                    <tr class="active">
                                        <td><span class="round"><img src="<?= ADMIN ?>/web/assets/images/users/2.jpg"
                ...
                <div class="col-lg-4 d-flex align-items-stretch">
                    <div class="card w-100">
                        <div class="up-img"
                             style="background-image:url(<?= ADMIN ?>/web/assets/images/big/img1.jpg)"></div>
                        <div class="card-body">
...
<script src="<?= ADMIN ?>/web/assets/node_modules/jquery/jquery.min.js"></script>
<!-- Bootstrap popper Core JavaScript -->
<script src="<?= ADMIN ?>/web/assets/node_modules/bootstrap/js/bootstrap.bundle.min.js"></script>
<!-- slimscrollbar scrollbar JavaScript -->
<script src="<?= ADMIN ?>/web/js/perfect-scrollbar.jquery.min.js"></script>
<!--Wave Effects -->
<script src="<?= ADMIN ?>/web/js/waves.js"></script>
<!--Menu sidebar -->
<script src="<?= ADMIN ?>/web/js/sidebarmenu.js"></script>
<!--Custom JavaScript -->
<script src="<?= ADMIN ?>/web/js/custom.min.js"></script>
<!-- ============================================================== -->
<!-- This page plugins -->
<!-- ============================================================== -->
<!--morris JavaScript -->
<script src="<?= ADMIN ?>/web/assets/node_modules/raphael/raphael-min.js"></script>
<script src="<?= ADMIN ?>/web/assets/node_modules/morrisjs/morris.min.js"></script>
<!--c3 JavaScript -->
<script src="<?= ADMIN ?>/web/assets/node_modules/d3/d3.min.js"></script>
<script src="<?= ADMIN ?>/web/assets/node_modules/c3-master/c3.min.js"></script>
<!-- Chart JS -->
<script src="<?= ADMIN ?>/web/js/dashboard1.js"></script>
</body>
